...
"本应用程序为免费软件，不收取任何费用，在使用过程中如有疑问或报告异常，可提issue至：\r\n"
"    https://github.com/KondeU/CommonSerialRelease    \r\n"
"版本信息：2.02 [ANSI]\r\n"
"开发者(v1)：女孩不哭（http://blog.twofei.com/566/）\r\n"
"开发者(v2)：KondeU（https://github.com/KondeU）\r\n"
"-----------------------------------------------------\r\n"
"软件说明:\r\n"
...
"-----------------------------------------------------\r\n"
"更新:\r\n"
"2017-11-17: 2.01 获得授权，接着原作者的代码添加波形绘制功能，新主版本号\r\n"
"    原开发中含有但实际没有实现或已移除的功能有：超时设置、驱动提供的设置、主接收窗口暂停显示、形状绘制、串口驱动过滤、字符串转16进制、检查软件新版本。\r\n"
"    修改了部分代码及图标，增添了波形绘制的功能。\r\n"
"-----------------------------------------------------\r\n"
"更新:\r\n"
"2021-08-26: v1版本master上有更新，同步更新到v2\r\n"
"    [2015-12-28] fix issue: 增加DTR/RTS引脚电平控制\r\n"
"\r\n\r\n";
		...
		<Vertical inset = "5,5,5,5">
			<Horizontal height="50" inset="0,0,0,0">
				...
				<Vertical inset="0,0,0,5">
					...
					<Static text="KondeU 开始于 2017-11-17" height="20"/>
				</Vertical>
			</Horizontal>
			...
			<Horizontal height="30" inset="0,5,0,0">
				<Control />
				<Button name="btn_website" text="v2.02开源地址" width="100" />
				<Control width="10" />
				<Button name="btn_ok" text="v1.20开源地址" width="100" />
				<Control />
			</Horizontal>
		</Vertical>
	</Vertical>
